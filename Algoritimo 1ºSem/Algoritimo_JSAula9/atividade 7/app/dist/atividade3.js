...
function cadastrarMensagem(mensagens, remetente, conteudo) {
    const novaMensagem = {
        remetente,
        conteudo,
        nivelSuspeita: 0,
...
function contarPalavrasProibidas(conteudo, palavrasProibidas) {
...
function classificarMensagem(mensagem, palavrasProibidas) {
...
function analisarTodasMensagens(mensagens, palavrasProibidas) {
    for (const mensagem of mensagens) {
        classificarMensagem(mensagem, palavrasProibidas);
    }
}
function listarMensagensSuspeitas(mensagens) {
...
function buscarPorRemetente(mensagens, remetente) {
    const resultado = [];
...
function listarMensagens(mensagens) {
...
const mensagens = [];
cadastrarMensagem(mensagens, "Carlos", "Olá, preciso recuperar minha senha.");
cadastrarMensagem(mensagens, "Marina", "Detectamos uma tentativa de ataque com malware e possível invasão.");
cadastrarMensagem(mensagens, "Roberto", "A reunião será amanhã às 14h.");
cadastrarMensagem(mensagens, "Carlos", "Houve suspeita de fraude, roubo de senha e instalação de vírus.");
...
//# sourceMappingURL=atividade3.js.map